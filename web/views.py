...
from web.base_views import BaseDetailView, BaseListView, BaseCreateView, BaseTemplateView
from web.forms import TripForm

class StartView( BaseTemplateView):
...
class TripDetailView(BaseDetailView):
	def get_context_data(self, **kwargs):
		...
		context['is_owner'] = True # self.object.tripuserrelationship.user
		return context
