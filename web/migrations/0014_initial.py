...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('web_invitation', (
            ('trip', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.Trip'])),
            ('emailAddress', self.gf('django.db.models.fields.EmailField')(max_length=200)),
            ('message', self.gf('django.db.models.fields.TextField')(max_length=200, null=True, blank=True)),
            ('uuid', self.gf('django.db.models.fields.IntegerField')(max_length=128, primary_key=True)),
            ('accepted', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('web', ['Invitation'])


    def backwards(self, orm):

        # Deleting model 'Invitation'
        db.delete_table('web_invitation')
    ...
    models = {
        ...
        'web.invitation': {
            ...
            'uuid': ('django.db.models.fields.IntegerField', [], {'max_length': '128', 'primary_key': 'True'})
        },
        'web.item': {
