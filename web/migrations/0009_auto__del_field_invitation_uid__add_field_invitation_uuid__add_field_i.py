...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Invitation.uid'
        db.delete_column('web_invitation', 'uid')

        # Adding field 'Invitation.uuid'
        db.add_column('web_invitation', 'uuid',
                      self.gf('django.db.models.fields.TextField')(default=1, max_length=32),
                      keep_default=False)

        # Adding field 'Invitation.accepted'
        db.add_column('web_invitation', 'accepted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Invitation.emailAddress'
        db.alter_column('web_invitation', 'emailAddress', self.gf('django.db.models.fields.EmailField')(max_length=200))
    def backwards(self, orm):
        # Adding field 'Invitation.uid'
        db.add_column('web_invitation', 'uid',
                      self.gf('django.db.models.fields.TextField')(default=0, max_length=32),
                      keep_default=False)

        # Deleting field 'Invitation.uuid'
        db.delete_column('web_invitation', 'uuid')

        # Deleting field 'Invitation.accepted'
        db.delete_column('web_invitation', 'accepted')


        # Changing field 'Invitation.emailAddress'
        db.alter_column('web_invitation', 'emailAddress', self.gf('django.db.models.fields.TextField')(max_length=200))
    models = {
        'auth.group': {
        ...
        'web.invitation': {
            ...
            'emailAddress': ('django.db.models.fields.EmailField', [], {'max_length': '200'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'uuid': ('django.db.models.fields.TextField', [], {'max_length': '32'})
        },
        'web.item': {
