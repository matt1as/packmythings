...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('web_invitation', 'uuid', self.gf('django.db.models.fields.BigIntegerField')(unique=True))
    def backwards(self, orm):

        # Changing field 'Invitation.uuid'
        db.alter_column('web_invitation', 'uuid', self.gf('django.db.models.fields.BigIntegerField')(max_length=32, unique=True))
    models = {
        'auth.group': {
        ...
        'web.invitation': {
            ...
            'uuid': ('django.db.models.fields.BigIntegerField', [], {'unique': 'True'})
        },
        'web.item': {
