...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TripUserRelationship'
        db.create_table('web_tripuserrelationship', (
        ...
        db.send_create_signal('web', ['TripUserRelationship'])

        # Deleting field 'Trip.owner'
        db.delete_column('web_trip', 'owner_id')


    def backwards(self, orm):
        # Deleting model 'TripUserRelationship'
        db.delete_table('web_tripuserrelationship')

        # Adding field 'Trip.owner'
        db.add_column('web_trip', 'owner',
