...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Invitation.message'
        db.alter_column('web_invitation', 'message', self.gf('django.db.models.fields.TextField')(max_length=200, null=True))
    def backwards(self, orm):

        # Changing field 'Invitation.message'
        db.alter_column('web_invitation', 'message', self.gf('django.db.models.fields.TextField')(default='message', max_length=200))
    models = {
        'auth.group': {
