...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ItemListPlugin'
        db.create_table('cmsplugin_itemlistplugin', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('trip', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.Trip'])),
        ))
        db.send_create_signal('web', ['ItemListPlugin'])

        # Adding field 'ItemTypeOfTripRelationship.owner'
        db.add_column('web_itemtypeoftriprelationship', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ItemListPlugin'
        db.delete_table('cmsplugin_itemlistplugin')

        # Deleting field 'ItemTypeOfTripRelationship.owner'
        db.delete_column('web_itemtypeoftriprelationship', 'owner_id')
