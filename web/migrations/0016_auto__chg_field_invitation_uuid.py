...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Invitation.uuid'
        db.alter_column('web_invitation', 'uuid', self.gf('django.db.models.fields.BigIntegerField')(unique=True, max_length=32))
    def backwards(self, orm):

        # Changing field 'Invitation.uuid'
        db.alter_column('web_invitation', 'uuid', self.gf('django.db.models.fields.TextField')(max_length=32, unique=True))
    models = {
        'auth.group': {
        ...
        'web.invitation': {
            ...
            'uuid': ('django.db.models.fields.BigIntegerField', [], {'unique': 'True', 'max_length': '32'})
        },
        'web.item': {
