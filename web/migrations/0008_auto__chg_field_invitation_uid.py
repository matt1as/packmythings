...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Invitation.uid'
        db.alter_column('web_invitation', 'uid', self.gf('django.db.models.fields.TextField')(max_length=32))
    def backwards(self, orm):

        # Changing field 'Invitation.uid'
        db.alter_column('web_invitation', 'uid', self.gf('django.db.models.fields.TextField')(max_length=128))
    models = {
        'auth.group': {
        ...
        'web.invitation': {
            ...
            'emailAddress': ('django.db.models.fields.TextField', [], {'max_length': '200'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'uid': ('django.db.models.fields.TextField', [], {'max_length': '32'})
        },
        'web.item': {
